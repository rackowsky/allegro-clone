...
import aukcje_ from "../../images/menu/aukcje.png";
import dodaj_aukcje_ from "../../images/menu/dodaj_aukcje.png";
import profil_ from "../../images/menu/profil.png";
import ustawienia_ from "../../images/menu/ustawienia.png";
import wyloguj_ from "../../images/menu/wyloguj.png";
  ...
  return (
    <ModeMenuWrapper>
      <div style={{ position: "relative", zIndex: 250 }}>
        <HeaderUser>Witaj, Bartosz</HeaderUser>
        <ModeMenuSlider>
          <Flickity
